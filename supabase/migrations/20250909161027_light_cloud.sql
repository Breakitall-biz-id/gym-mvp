/*
  # Gym Management System Database Schema - Fixed Dependencies

  1. New Tables
    - `members` - Gym members (created first)
    - `profiles` - User profiles linked to auth.users (references members)
...
-- Create profiles table (references members)
